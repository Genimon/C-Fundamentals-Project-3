...
Enter F to select Facebook Likes
Enter N to select Names Reversal 
Enter U to select Unique Numbers 
Enter C to select Collection of numbers 
Enter L to select List of numbers");

                var selection = (string)Console.ReadLine(); // Making selection of the program to access.


                const string facebook = "f";
                const string reversal = "n";
                const string unique = "u";
                ...
                switch (selection.ToLower())
                {
                    case facebook:
                        Console.WriteLine();
                        Console.WriteLine(@"You selected Facebook Likes.
This program counts the numbers of likes to your post based on the names you supply");
                        Console.WriteLine("Enter the name of a friend or Enter to exit the program");
                        //Console.WriteLine();
                        Console.WriteLine(Arrays_and_Lists_Exercises.Facebook ()); // Accessing Facebook Like Program
                        Console.WriteLine();
                        continue;
...
This program reversed the name inputted into the console.");
                        ...
                        Console.WriteLine(Arrays_and_Lists_Exercises.NameReverse ()); // Accessing Names Reversal Program
                        Console.WriteLine();
                        continue;

                    case unique:
                        Console.WriteLine();
                        Console.WriteLine(@"You selected Unique Numbers
This program sort the 5 unique numbers inputted into the console.");
                        Console.WriteLine("Enter 5 unique numers of your choice ");
                        //Console.WriteLine();
                        Console.WriteLine(Arrays_and_Lists_Exercises.UniqueNumbers ()); // Accessing Unique Numbers Program
                        Console.WriteLine();
                        continue;

                    case collection:
                        Console.WriteLine();
                        Console.WriteLine("You selected Collection of Numbers");
                        Console.WriteLine ("Enter a number or type \"Quit\" to exit the program");
                        //Console.WriteLine();
                        Console.WriteLine(Arrays_and_Lists_Exercises.NumberCollection ()); // Accessing Collection of Numbers Program
                        Console.WriteLine();
                        continue;

                    case list:
                        Console.WriteLine();
                        Console.WriteLine("You selected List of Number");
                        Console.WriteLine("Enter a series of numbers separated by comma. " +
                            "The list of numbers must be more than 5");
                        //Console.WriteLine();
                        Console.WriteLine(Arrays_and_Lists_Exercises.NumbersList ()); // Accessing List of Number Program
                        Console.WriteLine();
                        continue;
